...
public final class Message extends Table {
  ...
  public RadioState radioState(RadioState obj) { int o = __offset(16); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  ...
  public static void addRadioState(FlatBufferBuilder builder, int radioStateOffset) { builder.addStruct(6, radioStateOffset, 0); }
